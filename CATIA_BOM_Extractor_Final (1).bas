...
' UPDATED: Added "Level" column to show product tree depth
' ==============================================================================
...
Sub GenerateMasterBOM()
    ...
    Call TraverseTree(rootProd, dictQty, dictRef, dictDesc, dictProps, dictLevel, 1)
...
Sub TraverseTree(oProd As Product, dQty As Object, dRef As Object, dDesc As Object, _
                 dProps As Object, dLevel As Object, ByVal currentLevel As Integer)
    ...
    If oProd.Products.Count > 0 Then
        For i = 1 To oProd.Products.Count
            ...
            If childProd.Products.Count > 0 Then
                Call TraverseTree(childProd, dQty, dRef, dDesc, dProps, dLevel, currentLevel + 1)
            Else
                partNum = ""
                On Error Resume Next
